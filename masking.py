...
Code as is from Fast Scabale Attention Paper. The code belongs to the authors of the paper. 
Added here fro simplicity.

- Full mask (any key masked for any query)
- Length mask (masking out everything after a length). Cropping or Truncation.
